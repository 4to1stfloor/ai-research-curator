...
매주 자동으로 생성되는 HTML 리포트의 구조입니다:

```
┌─────────────────────────────────────────────────────────┐
│  📄 Paper Digest - 2026-03-10                           │
│  논문 5편 · Nature Communications, eLife, Science ...   │
├─────────────────────────────────────────────────────────┤
│                                                         │
│  ┌─ 1 ──────────────────────────────────────────────┐   │
│  │  📌 논문 제목 (영문 원제)                          │   │
│  │  Nature Communications · 2026-03-07 · DOI 링크    │   │
│  │                                                   │   │
│  │  ── 연구 개요 ──────────────────────────────────   │   │
│  │  ▎ Single-cell 및 spatial transcriptomics를       │   │
│  │  ▎ 통해 ... 보여준 연구입니다.  ← AI 한 줄 요약    │   │
│  │                                                   │   │
│  │  기존 연구에서는 ... 알려져 있었지만, ...           │   │
│  │  명확하지 않았습니다. ← AI가 쓴 연구 배경           │   │
│  │                                                   │   │
│  │  연구진은 ... 분석을 수행하여 ... 규명했습니다.     │   │
│  │  ← AI가 쓴 핵심 발견                               │   │
│  │                                                   │   │
│  │  본 연구는 ... 시사합니다. ← AI가 쓴 의의           │   │
│  │                                                   │   │
│  │  ── Abstract (한국어 번역) ─────────────────────   │   │
│  │  원문: Background: Intratumoral heterogeneity...  │   │
│  │  번역: 배경: Intratumoral heterogeneity는...      │   │
│  │                                                   │   │
│  │  ── Figures ────────────────────────────────────   │   │
│  │  [Figure 1]  [Figure 2]  [Figure 3] ...           │   │
│  │                                                   │   │
│  │  ── Figure 해설 ───────────────────────────────   │   │
│  │  Figure 1: ... 실험 결과를 보여줍니다.             │   │
│  │  Figure 2: ... 분석 결과입니다.                    │   │
│  │                                                   │   │
│  │  ── 연구 흐름도 (Mermaid) ─────────────────────   │   │
│  │  ┌──────┐   ┌──────┐   ┌──────┐                   │   │
...
> **연구 개요**는 Abstract 단순 번역이 아닙니다. AI가 논문 전문(본문 + 초록)을 읽고, 연구 배경 → 핵심 발견 → 의의를 4문단 산문체로 재구성한 요약입니다.
