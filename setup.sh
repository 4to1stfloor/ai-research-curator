...
echo ""
echo "  예시:"
echo "    ~/my-research          (홈 디렉토리 하위)"
echo "    /home/user/papers      (Linux 절대경로)"
echo "    /Users/user/papers     (macOS 절대경로)"
echo ""
...
echo "    bash scripts/setup_cron.sh remove    자동 실행 해제"
echo ""
echo -e "  ${BOLD}참고:${NC}"
echo "    crontab 자동 실행을 해제하려면:"
echo "    cd ${SCRIPT_DIR} && bash scripts/setup_cron.sh remove"
echo ""
